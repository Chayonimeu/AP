...
<html>
    <head>
        ...
        <title>Aashepashe | Privacy & Policy</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-clone"></i> System Settings | Privacy & Policy</div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="nav-tabs-custom">
                                                    <ul class="nav nav-tabs">
                                                        ...
                                                        <li class="active"><a href="<?php echo e(URL::to('portal/privacy')); ?>">Privacy & Policy</a></li>
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="active tab-pane">
                                                            <div class="box box-primary">
                                                                ...
                                                                <div class="box-body">
                                                                    <form class="" action="<?php echo e(url('portal/privacy/update')); ?>" method="post" enctype="multipart/form-data">
                                                                        <?php echo e(csrf_field()); ?>

                                                                        <input type="hidden" name="system_settings_id" value="<?php echo e($system_info->system_settings_id); ?>">
                                                                        <div class="form-group">
                                                                            <textarea class="form-control" name="privacy" id="privacy" required="required"><?php echo e($system_info->privacy); ?></textarea>
                                                                            <?php if($errors->has('privacy')): ?>
                                                                            <span class="help-block">
                                                                                <strong><i class="fa fa-warning"></i> <?php echo e($errors->first('privacy')); ?></strong>
                                                                            </span>
                                                                            <?php endif; ?>
                                                                        </div>
                                                                        <div class="form-group">
