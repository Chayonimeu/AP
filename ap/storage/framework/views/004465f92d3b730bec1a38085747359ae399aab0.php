                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <form role="form" class="" method="POST" action="<?php echo e(URL::to('portal/bedtype/update')); ?>" enctype="multipart/form-data">
                                                        <?php echo e(csrf_field()); ?>

                                                        <input type="hidden" name="bed_type_id" value="<?php echo e($data_list->bed_type_id); ?>" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" maxlength="255" placeholder="Enter Size" name="size" id="size" class="form-control" value="<?php echo e($data_list->size); ?>"/>
