...
<html>
    <head>
        ...
        <title>Aashepashe | Edit Sub Area Under <?php echo e($city_info->name); ?> City</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-clone"></i> Edit Sub Area Under <?php echo e($city_info->name); ?> City
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <form role="form" class="" method="POST" action="<?php echo e(URL::to('portal/subarea/update')); ?>" enctype="multipart/form-data">
                                                        <?php echo e(csrf_field()); ?>

                                                        <input type="hidden" name="sub_area_id" value="<?php echo e($data_list->sub_area_id); ?>" />
                                                        <input type="hidden" name="city_id" value="<?php echo e($city_info->city_id); ?>" />
                                                        <div class="form-group">
                                                            <label for="name">Name <b style="color: red">*</b></label>
                                                            <input type="text" maxlength="100" placeholder="Enter Name" name="name" id="name" class="form-control" value="<?php echo e($data_list->name); ?>" required/>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" maxlength="50" placeholder="Enter Latitude" name="latitude" id="latitude" class="form-control" value="<?php echo e($data_list->latitude); ?>" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="longitude">Longitude</label>
                                                            <input type="text" maxlength="50" placeholder="Enter Longitude" name="longitude" id="longitude" class="form-control" value="<?php echo e($data_list->longitude); ?>" />
                                                        </div>
                                                        <div class="form-group">
