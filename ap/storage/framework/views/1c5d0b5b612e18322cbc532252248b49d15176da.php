                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo e(URL::to('login')); ?>"><span class="glyphicon glyphicon-cog"></span>Account Settings</a></li>
                                        <li class="divider"></li>
                                ...
                                <div id="carousel-example-generic" class="carouse                                                                                                                                                                                                        l slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <img style="width: 100%;height: 300px" src="<?php echo e(asset('frontend/images/b3.jpg')); ?>" alt="First slide" class="img img-responsive">
                                            <div class="carousel-caption">
                                                First Slide
                                            </div>
                                        </div>
                                        <div class="item">
                                            <img style="width: 100%;height: 300px" src="<?php echo e(asset('frontend/images/b3.jpg')); ?>" alt="Second slide" class="img img-responsive">
                                            <div class="carousel-caption">
                                                Second Slide
                                            </div>
                                        </div>
                                        <div class="item">
                                            <img style="width: 100%;height: 300px" src="<?php echo e(asset('frontend/images/b3.jpg')); ?>" alt="Third slide" class="img img-responsive">
                                            <div class="carousel-caption">
                                                Third Slide
                                            </div>
                                        </div>
                                ...
                                <div class="box box-widget widget-user-2">
                                    <div class="widget-user-header bg-aqua-active">
                                        <div class="widget-user-image">
                                            <center>
                                                <img class="img-circle" src="<?php echo e(asset('frontend/images/avatar.jpg')); ?>" alt="Avatar">
                                            </center>
                                        </div>
                                    ...
                                    <div class="box-footer">
                                        <a href="<?php echo e(URL::to('/register')); ?>" class="btn btn-danger btn-block btn-sm" style="font-size: 16px"><i class="fa fa-check"></i> Register Your Account</a>
                                        <center>
                                            <a style="font-weight: bold;font-size: 20px;">OR</a>
                                        </center>
                                        <a href="<?php echo e(URL::to('/login')); ?>" class="btn btn-primary btn-block btn-sm" style="font-size: 16px"><i class="fa fa-sign-in"></i> Login Into                                                                                                                                                                                                         Account</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <section class="hotel_slider slider">
                                            <div class="slide">
                                                <a href=""title="Name Goes Here">
                                                    <img src="<?php echo e(asset('frontend/images/h4.jfif')); ?>">
                                            ...
                                            <div class="slide">
                                                <a href=""title="Name Goes Here">
                                                    <img src="<?php echo e(asset('frontend/images/h6.jpg')); ?>">
                                                    <h5>The WAY Dhaka</h5>
                                                </a>
                                                <span>
                                                    <i class="fa fa-star icon"></i>
                                            ...
                                            <div class="slide">
                                                <a href="" title="Name Goes Here">
                                                    <img src="<?php echo e(asset('frontend/images/h5.jpg')); ?>">
                                            ...
                                            <div class="slide">
                                                <a href="" title="Name Goes Here">
                                                    <img src="<?php echo e(asset('frontend/images/h7.jfif')); ?>">
                                                    <h5>Pan Pacific Sonargaon</h5>
                                                </a>
                                                <span>
                                                    <i class="fa fa-star icon"></i>
                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        <section class="restaurant_slider slider">
                                            <div class="slide">
                                                <a href=""title="Name Goes Here">
                                                    <img src="<?php echo e(asset('frontend/images/h1.jpg')); ?>">
                                            ...
                                            <div class="slide">
                                                <a href=""title="Name Goes Here">
                                                    <img src="<?php echo e(asset('frontend/images/h2.jpg')); ?>">
                                            ...
                                            <div class="slide">
                                                <a href="" title="Name Goes Here">
                                                    <img src="<?php echo e(asset('frontend/images/h3.jpg')); ?>">
                                                    <h5>Star Kabab & Restaurant</h5>
                                                </a>
                                                <span>
                                                    <i class="fa fa-star icon"></i>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6" style="height: 200px;border: 1px solid #ecf0f5">
                                <center>
                                    ...
                                    <a href="<?php echo e(URL::to('merchant/login')); ?>" class="btn btn-primary btn-block btn-sm" style="font-size: 16px"><i class="fa fa-sign-in"></i> Sign In</a>
                                </center>
                            </div>
                            <div class="col-md-6" style="height: 200px;border: 1px solid #ecf0f5">
                                <center>
                                    ...
                                    <a href="<?php echo e(URL::to('/merchant/register')); ?>" class="btn btn-danger btn-block btn-sm" style="font-size: 16px"><i class="fa fa-check"></i> Register Now</a>
                                </center>
                            </div>
                        </div>
                    </div>
