                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    ...
                                                    <form role="form" method="POST" action="<?php echo e(URL::to('portal/slider/store')); ?>" enctype="multipart/form-data">
                                                        <?php echo e(csrf_field()); ?>

                                                        <div class="form-group">
                                                            <label class="control-label" for="details">Text</label>
                                                            <input type="text" class="form-control" name="details" id="details" value="<?php echo e(old('details')); ?>" />
