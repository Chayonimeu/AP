                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <form role="form" class="" method="POST" action="<?php echo e(URL::to('portal/district/update')); ?>" enctype="multipart/form-data">
                                                        <?php echo e(csrf_field()); ?>

                                                        <input type="hidden" name="districtId" value="<?php echo e($dataList->districtId); ?>" />
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" name="districtDivisionId" id="districtDivisionId" required>
                                                                ...
                                                                <?php $__currentLoopData = $divisionList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $division): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($division->divisionId); ?>"<?php echo e(($dataList->districtDivisionId == $division->divisionId) ? 'selected' : ''); ?>><?php echo e($division->divisionName); ?></option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="Enter Name" name="districtName" id="districtName" class="form-control" value="<?php echo e($dataList->districtName); ?>" required/>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="Enter Latitude" name="districtLat" id="districtLat" class="form-control" value="<?php echo e($dataList->districtLat); ?>" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="districtLong">Longitude</label>
                                                            <input type="text" placeholder="Enter Longitude" name="districtLong" id="districtLong" class="form-control" value="<?php echo e($dataList->districtLong); ?>" />
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" name="districtStatus" id="districtStatus" required>
                                                                <option value="Active"<?php echo e(($dataList->districtStatus == 'Active') ? 'selected' : ''); ?>>Active</option>
                                                                <option value="Inactive"<?php echo e(($dataList->districtStatus == 'Inactive') ? 'selected' : ''); ?>>Inactive</option>
                                                            </select>
