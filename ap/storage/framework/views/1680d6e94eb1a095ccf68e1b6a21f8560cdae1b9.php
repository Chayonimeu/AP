...
<html>
    <head>
        <title>Aashepashe | Merchant Login Area</title>
        <meta charset="UTF-8">
        ...
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <form role="form" action="<?php echo e(URL::to('portal/merchant/authenticate')); ?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <button class="btn btn-primary btn-block"><i class="fa fa-check"></i> Sign In</button>
                        </div>
                    </div>
                </form>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="col-xs-12" style="border: 1px solid #48a0d6">
                            ...
                            <center><span>Email: willsmith@yahoo.com</span></center>
                            <center><span>Password: willsmith@yahoo.com</span></center>
                        </div>
                    </div>
                </div>
                <div class="row">
