...
<html>
    <head>
        ...
        <title>Aashepashe | Edit Hotel Facility</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-clone"></i> Edit Hotel Facility
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <form role="form" class="" method="POST" action="<?php echo e(URL::to('portal/hotel/facility/update')); ?>" enctype="multipart/form-data">
                                                        <?php echo e(csrf_field()); ?>

                                                        <input type="hidden" name="hotel_facility_id" value="<?php echo e($data_list->hotel_facility_id); ?>" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" name="is_charged" id="is_charged" required>
                                                                <option value="No"<?php echo e(($data_list->is_charged == 'No') ? 'selected' : ''); ?>>No</option>
                                                                <option value="Yes"<?php echo e(($data_list->is_charged == 'Yes') ? 'selected' : ''); ?>>Yes</option>
                                                            </select>
