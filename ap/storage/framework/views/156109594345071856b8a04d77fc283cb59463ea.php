                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <img src="<?php echo e(asset('upload/admin/avatar/'.$data->avatar)); ?>" alt="Image" class="img img-circle img-responsive" style="width: 40px;height: 30px"/>
                                                                <?php else: ?>
                                                                <img src="<?php echo e(asset('frontend/images/default.jpg')); ?>" alt="Image" class="img img-circle img-responsive" style="width: 40px;height: 30px"/>
                                                                <?php endif; ?>
                                                            </td>
                                                            <td>
                                                                <?php if($data->type == 'Admin'): ?>
                                                                <span class="label label-success"><?php echo e($data->type); ?></span>
                                                                <?php else: ?>
                                                                <span class="label label-warning"><?php echo e($data->type); ?></span>
                                                                <?php endif; ?>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <a class="action_style" href="<?php echo e(URL::to('portal/admin/edit/'.$data->admin_id)); ?>"><i class="fa fa-edit"></i> Edit</a>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td class="text-left" colspan="1">
                                                                <a href="<?php echo e(URL::to('portal/admin/add')); ?>">
