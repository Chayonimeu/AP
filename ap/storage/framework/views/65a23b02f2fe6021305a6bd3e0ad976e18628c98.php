                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-clone"></i> Edit Faq</div>
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <?php echo $__env->make('backend.layout.message', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                <form role="form" method="POST" action="<?php echo e(URL::to('portal/faq/update')); ?>" enctype="multipart/form-data">
                                                    <?php echo e(csrf_field()); ?>

                                                    <input type="hidden" name="faq_id" value="<?php echo e($data_list->faq_id); ?>" />
                                                    <div class="form-group">
                                                        <label class="control-label" for="question">Question <b style="color: red">*</b></label>
                                                        <textarea class="form-control" name="question" id="question"><?php echo e($data_list->question); ?></textarea>
                                                        <?php if($errors->has('question')): ?>
                                                        <span class="help-block">
                                                            <strong><i class="fa fa-warning"></i> <?php echo e($errors->first('question')); ?></strong>
                                                        </span>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label" for="answer">Answer <b style="color: red">*</b></label>
                                                        <textarea class="form-control" name="answer" id="answer"><?php echo e($data_list->answer); ?></textarea>
                                                        <?php if($errors->has('answer')): ?>
                                                        <span class="help-block">
                                                            <strong><i class="fa fa-warning"></i> <?php echo e($errors->first('answer')); ?></strong>
                                                        </span>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="form-group">
