                            ...
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form role="form" class="" method="POST" action="<?php echo e(URL::to('portal/merchant/hotel/store')); ?>" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-control select2" name="branch_id" id="branch_id" required>
                                                                                ...
                                                                                <option value="<?php echo e($branch->branch_id); ?>"<?php echo e((old('branch_id') == $branch->branch_id) ? 'selected' : ''); ?>><?php echo e($branch->name); ?></option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-control select2" name="property_id" id="property_id" required>
                                                                                ...
                                                                                <option value="<?php echo e($property->property_id); ?>"<?php echo e((old('property_id') == $property->property_id) ? 'selected' : ''); ?>><?php echo e($property->name); ?></option>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            </select>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" placeholder="Enter Hotel Name" name="name" id="name" class="form-control" value="<?php echo e(old('name')); ?>" required/>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" placeholder="Enter Hotel Address" name="address" id="address" class="form-control" value="<?php echo e(old('address')); ?>" required/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <?php if($errors->has('hotel_image')): ?>
                                                                            <span class="help-block">
                                                                                <strong><i class="fa fa-warning"></i> <?php echo e($errors->first('hotel_image')); ?></strong>
                                                                            </span>
                                                                            <?php endif; ?>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <?php if($errors->has('certification_image')): ?>
                                                                            <span class="help-block">
                                                                                <strong><i class="fa fa-warning"></i> <?php echo e($errors->first('certification_image')); ?></strong>
                                                                            </span>
                                                                            <?php endif; ?>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" placeholder="Enter Latitude" name="latitude" id="latitude" class="form-control" value="<?php echo e(old('latitude')); ?>"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="longitude">Longitude</label>
                                                                            <input type="text" placeholder="Enter Longitude" name="longitude" id="longitude" class="form-control" value="<?php echo e(old('longitude')); ?>"/>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group date">
                                                                                ...
                                                                                <input type="text" class="form-control pull-right" id="datepicker" name="opening_date" value="<?php echo e(old('opening_date')); ?>" required="required">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group date">
                                                                                ...
                                                                                <input type="text" class="form-control pull-right" id="datepicker" name="renovation_date" value="<?php echo e(old('renovation_date')); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-control select2" name="star_rating" id="star_rating" required>
                                                                                ...
                                                                                <option value="1"<?php echo e((old('star_rating') == '1') ? 'selected' : ''); ?>>1 Star</option>
                                                                                <option value="2"<?php echo e((old('star_rating') == '2') ? 'selected' : ''); ?>>2 Star</option>
                                                                                <option value="3"<?php echo e((old('star_rating') == '3') ? 'selected' : ''); ?>>3 Star</option>
                                                                                <option value="4"<?php echo e((old('star_rating') == '4') ? 'selected' : ''); ?>>4 Star</option>
                                                                                <option value="5"<?php echo e((old('star_rating') == '5') ? 'selected' : ''); ?>>5 Star</option>
                                                                                <option value="0"<?php echo e((old('star_rating') == '0') ? 'selected' : ''); ?>>Not Rated</option>
                                                                            </select>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number" min="1" placeholder="Enter Total No of Rooms" name="total_room" id="total_room" class="form-control" value="<?php echo e(old('total_room')); ?>" required/>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="url" placeholder="Enter Valid URL" name="website" id="website" class="form-control" value="<?php echo e(old('website')); ?>"/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" name="details" id="details" required><?php echo e(old('details')); ?></textarea>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" placeholder="Enter Contact Person Name" name="contact_name" id="contact_name" class="form-control" value="<?php echo e(old('contact_name')); ?>"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="contact_phone">Contact Phone</label>
                                                                            <input type="text" placeholder="Enter Contact Person Phone" name="contact_phone" id="contact_phone" class="form-control" value="<?php echo e(old('contact_phone')); ?>"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="contact_email">Contact Email</label>
                                                                            <input type="email" placeholder="Enter Contact Person Email" name="contact_email" id="contact_email" class="form-control" value="<?php echo e(old('contact_email')); ?>"/>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
