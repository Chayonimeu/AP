...
<html>
    <head>
        ...
        <title>Aashepashe | Business Area (City)</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-clone"></i> Business Area (City List For <?php echo e($country_info->name); ?>)
                                                ...
                                                <table id="table" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="action_style" href="<?php echo e(URL::to('portal/city/edit/'.$country_info->country_id .'/'.$data->city_id)); ?>"><i class="fa fa-edit"></i> Edit City</a><br>
                                                                <a class="action_style" href="<?php echo e(URL::to('portal/subarea/'.$data->city_id)); ?>"><i class="fa fa-list"></i> Sub Area</a>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td class="text-left" colspan="1">
                                                                <a href="<?php echo e(URL::to('portal/city/add/'.$country_info->country_id)); ?>">
