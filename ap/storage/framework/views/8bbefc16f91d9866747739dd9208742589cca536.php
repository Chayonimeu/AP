...
<html>
    <head>
        ...
        <title>Aashepashe | Edit Room Type (Hotel)</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-clone"></i> Edit Room Type (Hotel)
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <form role="form" class="" method="POST" action="<?php echo e(URL::to('portal/roomtype/update')); ?>" enctype="multipart/form-data">
                                                        <?php echo e(csrf_field()); ?>

                                                        <input type="hidden" name="room_type_id" value="<?php echo e($data_list->room_type_id); ?>" />

                                                        <div class="form-group">
                                                            <label for="name">Name <b style="color: red">*</b></label>
                                                            <input type="text" maxlength="255" placeholder="Enter Name" name="name" id="name" class="form-control" value="<?php echo e($data_list->name); ?>" required/>
        ...
        <script type="text/javascript">
            $("#roomtype_active").addClass("active");
            $("#roomtype_active").parent().parent().addClass("treeview active");
            $("#roomtype_active").parent().addClass("in");
        </script>
    </body>
</html>
