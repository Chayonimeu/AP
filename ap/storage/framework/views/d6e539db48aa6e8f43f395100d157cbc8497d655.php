...
<html>
    <head>
        ...
        <title>Aashepashe | About Us</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-clone"></i> System Settings | About Us</div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="nav-tabs-custom">
                                                    <ul class="nav nav-tabs">
                                                        ...
                                                        <li class="active"><a href="<?php echo e(URL::to('portal/about')); ?>">About Us</a></li>
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="active tab-pane">
                                                            <div class="box box-primary">
                                                                ...
                                                                <div class="box-body">
                                                                    <form class="" action="<?php echo e(url('portal/about/update')); ?>" method="post" enctype="multipart/form-data">
                                                                        <?php echo e(csrf_field()); ?>

                                                                        <input type="hidden" name="system_settings_id" value="<?php echo e($system_info->system_settings_id); ?>">
                                                                        <div class="form-group">
                                                                            <textarea class="form-control" name="about_us" id="about_us" required="required"><?php echo e($system_info->about_us); ?></textarea>
                                                                            <?php if($errors->has('about_us')): ?>
                                                                            <span class="help-block">
                                                                                <strong><i class="fa fa-warning"></i> <?php echo e($errors->first('about_us')); ?></strong>
                                                                            </span>
                                                                            <?php endif; ?>
                                                                        </div>
                                                                        <div class="form-group">
