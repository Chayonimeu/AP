...
<html>
    <head>
        ...
        <title>Aashepashe | Hotel Facility</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-clone"></i> Hotel Facility</div>
                                                ...
                                                <table id="table" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($data->is_charged); ?></td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <a class="action_style" href="<?php echo e(URL::to('portal/hotel/facility/edit/'.$data->hotel_facility_id)); ?>"><i class="fa fa-edit"></i> Edit</a>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td class="text-left" colspan="1">
                                                                <a href="<?php echo e(URL::to('portal/hotel/facility/add')); ?>">
