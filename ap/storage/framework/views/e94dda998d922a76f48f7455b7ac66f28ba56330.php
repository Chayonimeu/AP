...
<html>
    <head>
        ...
        <title>Aashepashe | Edit Business Type (Sub Category)</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-clone"></i> Edit Sub Category For <span style="color: #1E4770"><?php echo e($category_info->name); ?></span></div>
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <form role="form" class="" method="POST" action="<?php echo e(URL::to('portal/subcategory/update')); ?>" enctype="multipart/form-data">
                                                        <?php echo e(csrf_field()); ?>

                                                        <input type="hidden" name="sub_category_id" value="<?php echo e($data_list->sub_category_id); ?>" />
