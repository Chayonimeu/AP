...
<html>
    <head>
        ...
        <title>Aashepashe | Room Type (Hotel)</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-clone"></i> Room Type (Hotel)</div>
                                                ...
                                                <table id="table" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="action_style" href="<?php echo e(URL::to('portal/roomtype/edit/'.$data->room_type_id)); ?>"><i class="fa fa-edit"></i> Edit</a>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td class="text-left" colspan="1">
                                                                <a href="<?php echo e(URL::to('portal/roomtype/add')); ?>">
