                            ...
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"> 
                                        <i class="fa fa-clone"></i> Hotel Activity Facilities For <?php echo e($data_list->name); ?>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form role="form" class="" method="POST" action="<?php echo e(URL::to('portal/merchant/hotel/activity/facilities/store')); ?>" enctype="multipart/form-data">
                                                    <?php echo e(csrf_field()); ?>

                                                    <input type="hidden" name="hotel_id" value="<?php echo e($data_list->hotel_info_id); ?>" />
                                                    <?php $__currentLoopData = $activity_facility; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-md-4">
                                                        <?php $activity_facility_check = App\ActivityWiseFacilityModel::where('hotel_id', $data_list->hotel_info_id)->where('facility_id', $facility->activity_facility_id)->select('facility_id')->first(); ?>
                                                       
                                                        <?php if($activity_facility_check['facility_id'] == $facility->activity_facility_id): ?>
                                                        <input type="checkbox" checked name="facility_id[]" value="<?php echo e($facility->activity_facility_id); ?>" />&nbsp; <?php echo e($facility->name); ?>

                                                        <?php else: ?>
                                                        <input type="checkbox" name="facility_id[]" value="<?php echo e($facility->activity_facility_id); ?>" />&nbsp; <?php echo e($facility->name); ?>
