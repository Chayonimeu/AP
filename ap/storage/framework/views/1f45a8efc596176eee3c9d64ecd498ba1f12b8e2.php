                            ...
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form role="form" class="" method="POST" action="<?php echo e(URL::to('portal/admin/update')); ?>" enctype="multipart/form-data">
                                                    <?php echo e(csrf_field()); ?>

                                                    <input type="hidden" name="admin_id" value="<?php echo e($data_list->admin_id); ?>" />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" maxlength="100" placeholder="Enter Email" name="email" id="email" class="form-control" value="<?php echo e($data_list->email); ?>" required/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" placeholder="Enter Phone" name="phone" id="phone" class="form-control" value="<?php echo e($data_list->phone); ?>" required />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="type" id="type" required>
                                                            <option value="Admin"<?php echo e(($data_list->type == 'Admin') ? 'selected' : ''); ?>>Admin</option>
                                                            <option value="Employee"<?php echo e(($data_list->type == 'Employee') ? 'selected' : ''); ?>>Employee</option>
                                                        </select>
