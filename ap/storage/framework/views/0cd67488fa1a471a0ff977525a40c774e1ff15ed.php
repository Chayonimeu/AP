                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <form role="form" class="" method="POST" action="<?php echo e(URL::to('portal/category/update')); ?>" enctype="multipart/form-data">
                                                        <?php echo e(csrf_field()); ?>

                                                        <input type="hidden" name="category_id" value="<?php echo e($data_list->category_id); ?>" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" name="type_name" id="type_name" required>
                                                                ...
                                                                <option value="<?php echo e($data->name); ?>"<?php echo e(($data_list->type_name == $data->name) ? 'selected' : ''); ?>><?php echo e($data->name); ?></option>
