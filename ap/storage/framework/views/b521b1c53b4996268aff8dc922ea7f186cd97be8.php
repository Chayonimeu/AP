...
<html>
    <head>
        ...
        <title>Aashepashe | Add Activity Facility (Hotel)</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-clone"></i> Add New Activity Facility (Hotel)
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <form role="form" class="" method="POST" action="<?php echo e(URL::to('portal/activity/facility/store')); ?>" enctype="multipart/form-data">
