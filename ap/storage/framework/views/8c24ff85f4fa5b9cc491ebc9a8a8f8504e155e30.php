...
<html>
    <head>
        ...
        <title>Aashepashe | Business Type (Category)</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-clone"></i> Business Type (Category)</div>
                                                ...
                                                <table id="categoryTable" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="action_style" href="<?php echo e(URL::to('portal/category/edit/'.$data->category_id)); ?>"><i class="fa fa-edit"></i> Edit Category</a><br>
                                                                <a class="action_style" href="<?php echo e(URL::to('portal/subcategory/'.$data->category_id)); ?>"><i class="fa fa-list-ul"></i> Sub Category</a>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td class="text-left" colspan="1">
                                                                <a href="<?php echo e(URL::to('portal/category/add')); ?>">
