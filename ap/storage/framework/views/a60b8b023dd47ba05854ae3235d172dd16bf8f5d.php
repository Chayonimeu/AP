                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <form role="form" class="" method="POST" action="<?php echo e(URL::to('portal/bedtype/store')); ?>" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" maxlength="255" placeholder="Enter Size" name="size" id="size" class="form-control" value="<?php echo e(old('size')); ?>"/>
